<nav class="row py-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ul class="breadcrumb text-primary d-flex fw-bold gap-1 list-unstyled justify-content-center mb-0">
        <li class="breadcrumb-item text-dark text-opacity-50">صفحه اصلی</li>
