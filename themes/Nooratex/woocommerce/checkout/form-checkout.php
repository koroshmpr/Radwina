                ...
                <div class="py-2">
                    ...
                    <div class="vstack gap-4">
                        ...
                        foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) { ?>
                            <div class="card">
                                <div class="row align-items-center g-4 justify-content-lg-evenly justify-content-center">
                                    <?php
                                    ...
                                    if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
                                        ...
                                        <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                                            ...
                                            <div class="col hstack gap-lg-3 flex-nowrap align-items-center justify-content-start">
                                                <td>
                                                    <?php
                                                    ...
                                                    if (!$product_permalink) {
                                                        ...
                                                        printf('<a class="p-4 product-thumbnail w-50" href="%s">%s</a>',
                                                        ...
                                                        <div>
                                                            <td class="product-remove ">
                                                                ...
                                                                echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                                                    ...
                                                                    sprintf(
                                                                        '<a class="ms-3" href="%s" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="bi bi-trash fs-5 text-primary"></i></a>',
